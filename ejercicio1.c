...
int main(){
    ...
    while(1){
        ...
        printf("8) Buscar un elemento en la lista\n");
        printf("9) Eliminar un elemento en una posicion\n");
        printf("10) Eliminar todos los elementos menores a un numero\n");
        printf("11) Salir\n");
        scanf("%d", &opc);
        ...
        switch(opc){
            ...
            case 8:
                printf("¿Que valor entero te gustaria buscar?\n");
                scanf("%d", &num);
                buscarElemento(a, num); 
                break;

            case 9:
                printf("¿Cual es la posicion del elemento que quieres eliminar?\n");
                scanf("%d", &posicion);
                borrarElemento(&a, posicion);
                printf("\n¡Operacion realizada!\n");
                break;
